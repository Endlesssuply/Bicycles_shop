...
class AddBicycleForm(FlaskForm):
    ...
    electric = StringField('Электрический', validators=[DataRequired()])
    ...
    submit = SubmitField('Добавить велосипед')
...
class SearchPriceForm(FlaskForm):
    ...
    start_price = IntegerField('Минимальная цена', validators=[DataRequired()], default=5000)
    end_price = IntegerField('Максимальная цена', validators=[DataRequired()], default=30000)
